...
<#--
    ...
    This template renders informations for developers. It also includes the livereload javascript for faster developing.
    Please check the frontend developer manual for more detailed informations.
-->
