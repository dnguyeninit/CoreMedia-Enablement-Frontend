...
/**
 * Interface values for ResourceBundle "ElasticSocialStudioPlugin".
 * @see ElasticSocialStudioPlugin_properties#INSTANCE
 */
interface ElasticSocialStudioPlugin_properties {

  SpacerTitle_elasticSocial: string;
  CMMail_text: string;
  CMMail_from_text: string;
  CMMail_from_emptyText: string;
  CMMail_subject_text: string;
  CMMail_subject_emptyText: string;
  CMMail_text_text: string;
  CMMail_text_emptyText: string;
  CMMail_contentType_text: string;
  CMMail_contentType_emptyText: string;
  CMMail_lang_text: string;
  CMMail_lang_emptyText: string;
  CMMail_country_text: string;
  CMMail_country_emptyText: string;
  CMMail_variants_text: string;
  CMMail_variants_emptyText: string;
  ESDynamicList_text: string;
  ESDynamicList_interval_text: string;
  ESDynamicList_aggregationType_text: string;
  ESDynamicList_channel_text: string;
  cmmail_help_text: string;
  cmmail_help_window_title: string;
  cmmail_help_window_content: string;
  cmmail_help_window_value: string;
  cmmail_help_window_description: string;
  cmmail_help_window_value_name: string;
  cmmail_help_window_value_givenName: string;
  cmmail_help_window_value_surName: string;
  cmmail_help_window_value_email: string;
  cmmail_help_window_value_token: string;
  cmmail_help_window_value_baseUrl: string;
  cmmail_help_window_value_commentText: string;
  cmmail_help_window_value_commentDate: string;
  cmmail_help_window_value_commentUrl: string;
  cmmail_help_window_value_replyText: string;
  cmmail_help_window_value_replyAuthorName: string;
  cmmail_help_window_value_replyDate: string;
  curated_content_create_article_button_tooltip: string;
  curated_content_create_pictures_button_tooltip: string;
  curated_content_create_gallery_button_tooltip: string;
  btn_close: string;
...
/**
 * Singleton for the current user Locale's instance of ResourceBundle "ElasticSocialStudioPlugin".
 * @see ElasticSocialStudioPlugin_properties
 */
const ElasticSocialStudioPlugin_properties: ElasticSocialStudioPlugin_properties = {
  ...
  cmmail_help_window_content: "In the email form you can set the text that is displayed to a user in an email. You can set values that are generated dynamically for each user. These values are:",
...
export default ElasticSocialStudioPlugin_properties;
